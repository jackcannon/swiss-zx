...
(($$2) => {
  ...
  $$2.readFile = (filepath) => (0, import_swiss_ak.retryOr)("", 2, 100, () => fs.readFile(filepath, { encoding: "utf8" }));
  $$2.writeFile = (filepath, contents) => (0, import_swiss_ak.retryOr)(void 0, 2, 100, () => fs.writeFile(filepath, contents, { encoding: "utf8" }));
